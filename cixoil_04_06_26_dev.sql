...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2026 a las 04:11:34
...
(2, 5, 51, '2026-06-04 21:03:25.194423', 40, '2026-05-31 23:16:09.376326'),
...
(8, 0, 5, '2026-06-04 21:03:25.165286', 50, '2026-06-04 21:03:25.113472'),
(9, 0, 11, '2026-06-04 21:03:25.234100', 48, '2026-06-04 21:03:25.203383');
...
(2, '2026-05-31 22:03:39.896296', 'INVOICE', 'F001', '00000001', 3114.12, 560.53, 3674.65, 'CASH', 'CANCELED', 2, 1),
...
CREATE TABLE `stock_movement` (
  ...
  `id_product` bigint DEFAULT NULL,
  `movement_type` enum('ADJUSTMENT_IN','ADJUSTMENT_OUT','IN','OUT','PURCHASE_RETURN','SALE_CANCELLATION','SALE_RETURN') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(11, 0, 5, 5, 50, 'SALE_CANCELLATION', '2026-05-31 22:03:39.896296', '2026-06-04 21:03:25.120427', '2026-06-04 21:03:25.120427'),
(12, 50, 1, 51, 40, 'SALE_CANCELLATION', '2026-05-31 22:03:39.896296', '2026-06-04 21:03:25.176819', '2026-06-04 21:03:25.176819'),
(13, 0, 11, 11, 48, 'SALE_CANCELLATION', '2026-05-31 22:03:39.896296', '2026-06-04 21:03:25.208324', '2026-06-04 21:03:25.208324');
...
--
ALTER TABLE `inventory`
  MODIFY `id_inventory` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `stock_movement`
  MODIFY `id_stock_movement` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
