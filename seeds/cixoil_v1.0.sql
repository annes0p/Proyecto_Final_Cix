...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2026 a las 19:16:29
...
CREATE TABLE `product` (
  ...
  `status` int DEFAULT NULL,
  `viscosity` decimal(38,2) DEFAULT NULL,
...
INSERT INTO `user` (`id_user`, `created_at`, `email`, `password`, `status`, `username`, `id_role`) VALUES
(1, '2026-05-25 09:43:34.000000', 'admin@admin.com', '$2a$10$Mt2ltioT746kMKL0v0bprOAKGV2TdoDKSN79uMv/789.Ph0M/HyDO', 1, 'admin', 1);
...
--
ALTER TABLE `client`
  MODIFY `id_client` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `document_series`
--
ALTER TABLE `document_series`
  MODIFY `id_document_series` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `location`
  MODIFY `id_location` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `notification`
  MODIFY `id_notification` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `product`
--
ALTER TABLE `product`
  MODIFY `id_product` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `product_brand`
--
ALTER TABLE `product_brand`
  MODIFY `id_product_brand` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `route`
  MODIFY `id_route` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `trip`
  MODIFY `id_trip` bigint NOT NULL AUTO_INCREMENT;
